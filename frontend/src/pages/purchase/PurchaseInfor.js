        ...
        <div>
            ...
            <div className={'border border-2 my-3'}>
                <div className={'d-flex mt-2'}>
                    <button type={'button'} className={'btn btn-success ms-2'} onClick={handleOriginalInfo}
                            disabled={oriButton}>기존 배송지
                    </button>
                    <button type={'button'} className={'btn btn-success ms-2'} onClick={handleNewInfo}
                            disabled={newButton}>새 배송지
                    </button>
                </div>
                ...
                <div className={'flex-row d-flex mt-4'}>
                    ...
                    <div className={'col-sm-2'}>
                        <input type={'text'} className={'form-control'} id={'postal'} value={zoneCode}
                               readOnly={true}/>
                    </div>
                    <div className={'col-sm-2'}>
                        <button type={'button'} className={'btn btn-primary ms-2'}
                                onClick={handleBtnZoneCode}>우편번호
                            찾기
                        </button>
                    </div>
                </div>
                <div className={'flex-row d-flex my-2'}>
                    ...
                    <div className={'col-sm-7'}>
                        <input type={'text'} className={'form-control'} id={'address'} placeholder={'주소'}
                               value={roadAddress} readOnly={true}/>
                        <input type={'text'} className={'form-control my-1'} id={'addressDetail'}
                               value={roadAddressDetail} onChange={handleRoadAddDetail} placeholder={'상세주소'}/>
                    </div>
                </div>
                <div className={'flex-row d-flex my-4'}>
                    <div className={'col-sm-2 text-center'}>
                        <label htmlFor={'phoneMiddleNumber'}
                               className={'form-label align-self-center mt-1'}>전화번호</label>
                    </div>
                    <div className={'col-sm-2'}>
                        <select className={'form-select'} id={'phoneFirstNumber'} value={phoneFirstNumber}
                    ...
                    <div className={'col-sm-2'}>
                        <input type={'text'} className={'form-control'} id={'phoneMiddleNumber'}
                               value={phoneMiddleNumber} onChange={handlePhoneMiddle} maxLength={4}/>
                    </div>
                    <div className={'form-label align-self-center mt-1'}>-</div>
                    <div className={'col-sm-2'}>
                        <input type={'text'} className={'form-control'} id={'phoneLastNumber'}
                               value={phoneLastNumber} onChange={handlePhoneLast} maxLength={4}/>
                    </div>
                </div>
                <div className={'flex-row d-flex my-4'}>
                    <div className={'col-sm-2 text-center'}>
                    ...
                    <div className={'col-sm-4'}>
                            <textarea className={'form-control-sm'} cols={90} rows={5} id={'message'} value={reqMessage}
                                      onChange={handleReqMessage} disabled={messageDis}/>
            ...
            <div className={'border border-2 my-3'}>
                <div className={'row my-4'}>
                    <div className={'flex-row d-flex my-4'}>
                        ...
                        <div className={'col-sm-3'}>
                            <input type={'text'} className={'form-control'} id={'userId'} value={orderAllFee}
                                   disabled={true}/>
                        </div>
                        <div className={'col-sm-2 text-center align-self-center'}>
                    ...
                    <div className={'flex-row d-flex my-4'}>
                        ...
                        <div className={'col-sm-3'}>
                            <input type={'text'} className={'form-control'} id={'userId'} value={deliveryFee}
                                   disabled={true}/>
                        </div>
                        <div className={'col-sm-2 text-center align-self-center'}>
                    ...
                    <div className={'flex-row d-flex my-4'}>
                        ...
                        <div className={'col-sm-3'}>
                            <input type={'text'} className={'form-control'} id={'userId'} value={finalFee}
                                   disabled={true}/>
                        </div>
                    </div>
                </div>
            ...
            <div className={'border border-2 my-3'}>
                <div className={'row ms-4 my-4'}>
                    <div className={'btn-group-vertical'} value={payMethod}>
                        <div className={'my-2'}>
                            <input type="radio" className={'form-check-input'} name="payment" value={0}
                                   checked={payMethod == 0} onChange={handlePayMethod}/>
                            <label className={'form-check-label ms-3'} htmlFor={'payment1'}>신용카드</label>
                        </div>
                        <div className={'my-2'}>
                            <input type="radio" className={'form-check-input'} name="payment" value={1}
                                   checked={payMethod == 1} onChange={handlePayMethod}/>
                            <label className={'form-check-label ms-3'} htmlFor={'payment1'}>카카오 페이</label>
                        </div>
                        <div className={'my-2'}>
                            <input type="radio" className={'form-check-input'} name="payment" value={2}
                                   checked={payMethod == 2} onChange={handlePayMethod}/>
                            <label className={'form-check-label ms-3'} htmlFor={'payment1'}>네이버 페이</label>
                        </div>
                        <div className={'my-2'}>
                            <input type="radio" className={'form-check-input'} name="payment" value={3}
                                   checked={payMethod == 3} onChange={handlePayMethod}/>
